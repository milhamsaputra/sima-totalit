...
<body>
          ...
          <td style="text-align:right;">
           <?php
              if($_SESSION['akses']=="Pemilik"){
                ...
                $tujuan=$_SESSION['akses']."/TranksaksiJual.html";
              }
            ?>
    ...
    <div class="utama">
        <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top:10px;font-size:12 0%;">
            <tr>
                <td width="7%" rowspan="3" align="center" valign="top">
                   ...
                   <td width="93%" valign="top">
                    <strong>&nbsp;&nbsp;&nbsp;Laporan Penjualan Barang</strong>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td valign="top">&nbsp;&nbsp;&nbsp;Perkantoran Dutamas Fatmawati Blok D2/05, Jl. Fatmawati Raya 12150
</td>
            </tr>
